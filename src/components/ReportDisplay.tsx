...
export const ReportDisplay: React.FC<ReportDisplayProps> = ({ report }) => {
  ...
  const handleDownload = () => {
    const reportContent = `
CREDIT ANALYSIS REPORT: ${report.companyName.toUpperCase()}
...
Generated by CreditAI Analyzer
    ...
    a.href = url;
    a.download = `${report.companyName.replace(/[^a-z0-9]/gi, '_')}_credit_report.txt`;
    ...
    toast({
      ...
      description: "Your credit analysis report has been saved as a text file.",
    });
  };
  ...
  const sections = [
    {
      ...
      description: 'Business model and market position analysis'
    },
    {
    ...
    },
    {
      ...
      description: 'Identified business and financial risk factors'
    },
    {
      ...
      description: 'Strategic insights and future outlook'
    }
  ];
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-base text-slate-600 font-medium">Credit Analysis Report</p>
              </div>
            </div>
